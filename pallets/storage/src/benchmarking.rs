...
use sp_std::prelude::*;
use super::*;
use frame_system::{RawOrigin as SystemOrigin, Pallet as System};
use frame_benchmarking::{
	benchmarks, account, whitelist_account, impl_benchmark_test_suite
};
...
const SEED: u32 = 0;
const FILE_ID_PREFIX: [u8; 43] = [81,109,83,57,69,114,68,86,120,72,88,82,78,77,74,82,74,53,105,51,98,112,49,122,120,67,90,122,75,80,56,81,88,88,78,72,49,121,101,101,101,101,101];
...
fn create_replica_nodes<T: Config>(num_replicas: u32, seed: u32, node: Option<T::AccountId>) -> Vec<T::AccountId> {
	...
	for i in 0..num_replicas {
		...
		Stashs::<T>::insert(node.clone(), StashInfo {
...
fn create_file_order<T: Config>(cid: &FileId, replicas: &[T::AccountId], settle: bool) {
	...
	FileOrders::<T>::insert(cid.clone(), FileOrder {
